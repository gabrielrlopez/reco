...
const FriendRequests = ({
    ...
    return (
        <>
        {currentUserFriendRequests.requests.length === 0 ? <NoFriendRequests /> : 
        <Container>
                ...
                <Container>
                    <h1>Friend Requests</h1>
                        ...
                        <Jumbotron style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
                            ...
                            <div>
                            <p>
                              <Button value={request.userId} onClick={acceptRequest} variant="success" style={{marginRight: "5px"}}>Accept</Button>
...
export default connect(mapStateToProps, {acceptFriendRequest, declineFriendRequest, reRender})(FriendRequests)